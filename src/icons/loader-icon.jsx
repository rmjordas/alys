...
export const LoaderIcon = forwardRef((svgProps, ref) => (
  <Icon {...svgProps} ref={ref}>
    <rect width="24" height="24" transform="rotate(180 12 12)" opacity="0" />
    <path fill="currentColor" d="M12 2a1 1 0 0 0-1 1v2a1 1 0 0 0 2 0V3a1 1 0 0 0-1-1z" />
    <path fill="currentColor" d="M21 11h-2a1 1 0 0 0 0 2h2a1 1 0 0 0 0-2z" />
    <path fill="currentColor" d="M6 12a1 1 0 0 0-1-1H3a1 1 0 0 0 0 2h2a1 1 0 0 0 1-1z" />
    <path
      fill="currentColor"
    ...
    />
    <path fill="currentColor" d="M12 18a1 1 0 0 0-1 1v2a1 1 0 0 0 2 0v-2a1 1 0 0 0-1-1z" />
    <path
      fill="currentColor"
