...
export const ColorPalleteIcon = forwardRef((svgProps, ref) => (
  <Icon {...svgProps} ref={ref}>
    ...
    <path fill="currentColor" d="M15.25 7.2a1.5 1.5 0 1 0 2.05.55 1.5 1.5 0 0 0-2.05-.55z" />
    <path fill="currentColor" d="M8.75 7.2a1.5 1.5 0 1 0 .55 2.05 1.5 1.5 0 0 0-.55-2.05z" />
    <path fill="currentColor" d="M6.16 11.26a1.5 1.5 0 1 0 2.08.4 1.49 1.49 0 0 0-2.08-.4z" />
  </Icon>
));

ColorPalleteIcon.displayName = 'ColorPalleteIcon';
