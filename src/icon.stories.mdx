...
import { IconShowcase } from './internal';
...
<Preview>
  <Story name="Icon as decoration">
    <button>
      <Icon style={{ marginRight: 10 }} aria-hidden>
        <circle cx="12" cy="12" r="9" stroke="lightsalmon" strokeWidth="3" fill="lightskyblue" />
      </Icon>
      My button text
    </button>
  </Story>
...
<Preview>
  <Story name="Icon as sole visual representation">
    <button>
      <Icon aria-label="Mark task as done.">
